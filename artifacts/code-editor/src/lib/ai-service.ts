...
// âââ Limites mÃ¡ximos por provedor ââââââââââââââââââââââââââââââââââââââââââââ
// Cada provedor tem seu teto de tokens de saÃ­da. Usamos o mÃ¡ximo suportado.
const PROVIDER_MAX_TOKENS: Record<string, number> = {
  openai:    16384,  // gpt-4o / gpt-4o-mini suportam atÃ© 16384
  anthropic: 32768,  // Claude 3+ suporta atÃ© 64k, mas 32k Ã© seguro
  google:    32768,  // Gemini 2.0 Flash suporta 8192 por padrÃ£o, mas 1.5 Pro vai atÃ© 64k
  custom:    16384,  // padrÃ£o para provedores desconhecidos
...
// âââ Chamada principal (sem streaming) âââââââââââââââââââââââââââââââââââââââ
...
// âââ OpenAI e compatÃ­veis (Groq, OpenRouter, xAI, Together, Mistral, Ollama) â
async function callOpenAICompatible(messages: AIMessage[], slot: AIKeySlot): Promise<string> {
  ...
  const headers: Record<string, string> = {
    ...
    "X-Title": "SK Code Editor â Jasmim",
  };
...
// âââ Anthropic Claude âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ Google Gemini (API nativa) âââââââââââââââââââââââââââââââââââââââââââââââ
...
// âââ IA embutida (cortesia via servidor) âââââââââââââââââââââââââââââââââââââ
...
/** Corpo da requisiÃ§Ã£o de streaming */
...
export async function testBuiltinAI(): Promise<{ ok: boolean; msg: string }> {
  try {
    ...
    return { ok: true, msg: `â Funcionando! Resposta: "${result.slice(0, 60)}"` };
  } catch (err: any) {
    return { ok: false, msg: `â ${err.message}` };
  }
}
...
export async function testAISlot(slot: AIKeySlot): Promise<{ ok: boolean; msg: string }> {
  try {
    const result = await sendAIMessage(
      [{ role: "user", content: "Responda apenas: OK" }],
      slot,
      "VocÃª Ã© um assistente. Responda apenas 'OK' e nada mais."
    );
    return { ok: true, msg: `â Funcionando! Resposta: "${result.slice(0, 60)}"` };
  } catch (err: any) {
    return { ok: false, msg: `â ${err.message}` };
...
// âââ ParsedBlock ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
